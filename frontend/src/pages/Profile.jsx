      ...
      <div className="flex flex-col bg-white dark:bg-gray-700">
        ...
        <div className="flex flex-row justify-between px-4">
          <div>
            <img
              src={ProfileImg}
              className="rounded-full h-20 w-20 border-2 border-white dark:border-gray-700 absolute top-28"
            />
          </div>
          <div className="mt-2">
        ...
        <div className="flex flex-row justify-between px-4">
          ...
          <div className="border-b-4 border-blue-500 w-20 rounded-sm absolute top-96 left-5 mt-1"></div>
